...
def task_to_schema(task: ProjectTask) -> ProjectTaskRead:
    return ProjectTaskRead(
        ...
        updates_memory=bool(task.updates_memory),
        memory_refresh_attempted_at=task.memory_refresh_attempted_at,
        memory_refresh_completed_at=task.memory_refresh_completed_at,
